...
# @nonamich/ts-proto
This is a fork of https://github.com/stephenh/ts-proto. added nestJsRequiredSubMessage option which removes “null | undefined” from required fields with sub-message.
